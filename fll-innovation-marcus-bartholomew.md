---
layout: page
title: "Innovation Project — Marcus Bartholomew the Third Junior"
---

# COCOPlus Hydration Packets
...
We started by studying what the body needs to stay hydrated. We discovered that **potassium, sodium, and magnesium** — along with water — are essential for proper hydration.

Our first idea was hydration stickers applied directly to the skin using transdermal absorption. However, we learned that transdermal absorption only delivers nutrients to the epidermis level, so it would only hydrate the skin — not the whole body. We needed a different approach.
...
We created three flavors designed to be mixed into water on the go:
...
We consulted **Dr. Dennis Imperio**, a general physician and active runner, who enjoyed our idea and wanted to try it. He advised us on simple hydration tests — checking knuckle skin elasticity and urine color before and after drinking our product. **The tests showed it hydrated us!**

## How COCOPlus Compares

After finalizing our formula, we developed nutrition facts and compared COCOPlus to Gatorlyte, Gatorade, and PerformX:

**Higher mineral content:**
- Calcium: 2652 mg (200% DV) for bone strength, muscle function, and hydration support
- Magnesium: 15% DV to help prevent cramps and support muscle recovery
- Iron: 20% DV for oxygen flow and energy levels

**Strong electrolyte replenishment:**
- Sodium: 2300 mg (100% DV), ideal for extreme heat, sweating, and labor-intensive work

**No added sugars:**
- 0g added sugars — all 27g of sugars are naturally occurring
...
COCOPlus stands out as a **high-performance, natural hydration solution** — built for extreme conditions. Whether archaeologists are braving scorching heat or freezing temperatures, COCOPlus keeps them fully hydrated, energized, and focused in the field. Perfect for archaeologists, adventurers, and anyone pushing their limits.

*COCOPlus — 100% Hydration, Anywhere, Anytime.*
